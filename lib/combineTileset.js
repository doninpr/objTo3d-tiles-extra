 ...
 * @param {String} [options.geometricError=500] Tileset geometricError.
 * @param {String} [options.refine="ADD"] Tielset refine method.
 */
function combineTileset(options) {
    ...
    var geometricError = defaultValue(tilesetOptions.geometricError, 500);
    var refine = defaultValue(tilesetOptions.refine, 'ADD');
    var children = [];
    var promises = [];
    var jsonFiles = [];
    ...
    jsonFiles.forEach(function(jsonFile) {
        var promise = fsExtra.readJson(jsonFile)
            .then(function(json) {
                ...
                var geometricError = json.geometricError || json.root.geometricError;
